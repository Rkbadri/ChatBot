<?php
  ...
  class chatClass
  {
    ...
    {
      (empty($p_watson_waorkspace_id)) ? $this->_watson_workspace_id = CONFIG_WATSON_WORKSPACE_ID : $this->_watson_workspace_id = $p_watson_workspace_id;
    ...
    */
    ...
    private function getWatsonResponse($p_input_text, $p_watson_context)
    {
      ...
      $api_url = "https://gateway-lon.watsonplatform.net/assistant/api/v1/workspaces/c9fa227e-25e8-4889-88d1-b27992abb289/message" . $watson_waorkspace_id . "/message?version=2017-05-26";
